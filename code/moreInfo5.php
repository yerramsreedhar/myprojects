<!-- Detailed information page for product - legalservices -->
<!-- ********************************************** -->
<!DOCTYPE html>
<html>
<meta charset="UTF-8">
...
<body>
 	  ...
 	  <div class="topnav">
	  <b href="#" style="height:30px;font-size:180%"><font face="verdana" size="5">Kisan Platform</b>
	  </div>
      <div class="topnav">
      <b align="left"><font face="verdana" size="3"><i style="font-size:24px;" class="fa">&#xf2b5;</i>A platform for buyers and sellers to interact directly</b>
	  <a style="text-indent:30em">&nbsp;</a>
	  <a class="active" href="homePage.php"><font face="verdana" size="3"><br>Home</a>
	  <a href="productForm.php"><font face="verdana" size="3"><br>Products</a>
      <a href="sellerForm.php"><font face="verdana" size="3"><br>Post Free Ad</a>
	  <a href="buyerForm.php"><font face="verdana" size="3"><br>Sign Up</a>
	  </div>
   ...
   <table>
	...
	<img src="images/Legal-Services.jpg" alt="Mountain View" style="margin-left:30px;width:200px;height:100px;">
